...
// Función para cargar las regiones en un elemento select
function cargarRegiones() {
    ...
    regionesYComunas.regiones.forEach(function(region) {
        ...
        regionesSelect.add(option);
    });
}

// Función para mostrar las comunas correspondientes a la región seleccionada
function showComunas() {
    ...
    // Encontrar las comunas correspondientes a la región seleccionada
    regionesYComunas.regiones.forEach(function(region) {
        if (region.region === regionSeleccionada) {
...
// Llamar a la función cargarRegiones cuando se cargue la página
window.onload = cargarRegiones;
// Llamar a la función showComunas cuando se seleccione una región
document.getElementById("regiones").addEventListener("change", showComunas);